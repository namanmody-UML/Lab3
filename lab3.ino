...
void translateIR()
{
  ...
  {
    case MODE:  fanDirectionChange(); break; 
    case ONE:   motorSpeed = 50;     break;
    case TWO:   motorSpeed = 128;    break;
    case THREE: motorSpeed = 180;    break;
    case FOUR:  motorSpeed = 255;    break;
    default: 
